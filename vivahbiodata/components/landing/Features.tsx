...
const Features = () => {
  ...
  return (
    <div className="w-full  dark:bg-background-dark/90 backdrop-blur-sm border-y border-border-soft transition-colors">
        ...
        <div className="flex flex-col md:flex-row gap-8 items-start md:items-center justify-between">
          ...
          <div className="flex-1 grid grid-cols-1 sm:grid-cols-3 gap-6 w-full">
            {features.map((feature, idx) => {
              ...
              return (
              <div key={idx} className="flex flex-col gap-3 p-4 rounded-lg  dark:bg-midnight-accent border border-border-soft shadow-md">
