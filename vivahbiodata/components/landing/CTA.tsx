...
const CTA = () => {
  return (
    <div className="w-full bg-primary/5 py-16 border-t border-primary/10">
      <div className="max-w-[960px] mx-auto px-4 text-center flex flex-col items-center gap-6">
        ...
        <a href='/templates' className="flex min-w-[200px] cursor-pointer items-center justify-center rounded-lg h-12 px-8 bg-primary hover:bg-primary-dark transition-all text-white text-lg font-bold shadow-lg">
          Create Biodata Now
        </a >
