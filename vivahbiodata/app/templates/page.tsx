    ...
    <div className="group rounded-2xl border border-border-soft bg-white dark:bg-midnight-accent overflow-hidden shadow-sm hover:shadow-lg transition-all duration-300">
      ...
      <div className="p-6">
        ...
        <div className="flex items-center gap-2 text-xs">
          ...
          {template.category && (
            <span className="px-2 py-1 bg-white dark:bg-midnight-accent text-text-muted rounded-full border border-border-soft text-xs font-medium">{template.category}</span>
          )}
        </div>
