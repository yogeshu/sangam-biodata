...
import ElegantBackground from "assets/images/backgrounds/elegant.jpg";
...
const styles = StyleSheet.create({
  ...
  page: {
    ...
    backgroundImage: `url("${ElegantBackground}")`, // Correct backgroundImage style
...
const ElegantTemplate = ({ biodata, background }) => (
  <Document>
    <Page size="A4" style={styles.page}>
      <View style={styles.pageBackground}>
        <Image src={ElegantBackground} style={styles.pageBackground} />
