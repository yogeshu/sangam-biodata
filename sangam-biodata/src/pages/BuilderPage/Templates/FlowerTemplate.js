...
import FlowerBackground from "assets/images/backgrounds/flower.jpg";
...
const styles = StyleSheet.create({
  ...
  page: {
    ...
    backgroundImage: `url("${FlowerBackground}")`, // Correct backgroundImage style
...
const FlowerTemplate = ({ biodata, background }) => (
  <Document>
    <Page size="A4" style={styles.page}>
      <View style={styles.pageBackground}>
        <Image src={FlowerBackground} style={styles.pageBackground} />
