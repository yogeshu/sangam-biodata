...
import ExpensiveBackground from "assets/images/backgrounds/expensive.jpg";
...
const styles = StyleSheet.create({
  ...
  page: {
    ...
    backgroundImage: `url("${ExpensiveBackground}")`, // Correct backgroundImage style
...
const ExpensiveTemplate = ({ biodata, background }) => (
  <Document>
